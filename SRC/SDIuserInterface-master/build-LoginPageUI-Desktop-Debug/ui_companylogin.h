...
public:
    ...
    void setupUi(QDialog *companylogin)
    {
        if (companylogin->objectName().isEmpty())
            companylogin->setObjectName(QString::fromUtf8("companylogin"));
        companylogin->resize(800, 600);
        verticalLayout_3 = new QVBoxLayout(companylogin);
        verticalLayout_3->setObjectName(QString::fromUtf8("verticalLayout_3"));
        menubar = new QMenuBar(companylogin);
        ...
        loginForm = new QWidget(companylogin);
        ...
        otherLogins = new QWidget(companylogin);
        ...
        horizontalLayout_6->addWidget(driverLoginButton);
    ...
    {
        companylogin->setWindowTitle(QApplication::translate("companylogin", "Dialog", nullptr));
        label->setText(QApplication::translate("companylogin", "Company\n"
"Login", nullptr));
        label_3->setText(QApplication::translate("companylogin", "Username:", nullptr));
        label_2->setText(QApplication::translate("companylogin", "Password: ", nullptr));
        loginButton->setText(QApplication::translate("companylogin", "Login", nullptr));
        pushButton_3->setText(QApplication::translate("companylogin", "Create New Account", nullptr));
        customerLoginButton->setText(QApplication::translate("companylogin", "Customer Login", nullptr));
        driverLoginButton->setText(QApplication::translate("companylogin", "Driver Login", nullptr));
    } // retranslateUi
